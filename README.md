# SILVER FORTRESS ASSETS
Public assets for the Silver Fortress custom weapons server.

Installation instructions

1. At the top of the page there's a green button that says "< > Code" clicking it will open up a dropdown menu
